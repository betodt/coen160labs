...
public class WTSim2 extends JFrame implements ActionListener, Observer{
	...
	public void update(Observable o,Object t){
	       ...
	       int volume = tank.getCurrentVolume();
	       if (volume <= 50){
	    	   message.setText("CRITICAL: "+volume+" Shutting off WaterTank");
	    	   tank.setShutOff(true);
	       }
	       else
	    	   message.setText("Levels OK: "+volume);
	    }  
